    ...
    public class BigBrain
    {
        public bool MainGameLoop()
        {
            while (true)
            {
                ...
                string userWeapon = rpsOptions.UserWeaponSelector();
                ...
                int userWeaponNumber = (int)playerWeapon.WeaponNumber;
                int computerWeaponNumber = (int)computerWeapon.WeaponNumber;
                string combatResult = rpsOptions.Combat(userWeaponNumber, computerWeaponNumber);
